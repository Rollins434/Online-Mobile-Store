...
namespace MobileStore.DatabaseFiles
{
    ...
    public partial class dbMobileStoreEntities : DbContext
    {
        public dbMobileStoreEntities()
            : base("name=dbMobileStoreEntities")
        {
        }
        ...
        public virtual DbSet<Tbl_MemeberRole> Tbl_MemeberRole { get; set; }
